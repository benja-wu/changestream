...
@Service
public class hub_tPlayerPoints extends BusinessTask {

    private static final String TASK_COLLECTION_NAME = "hub_tPlayerPoints";
    private final MongoClient mongoClient;
    private final String databaseName;
    private final AwardCalculationService awardCalculationService;

    public hub_tPlayerPoints(ResumeTokenService resumeTokenService, TpsCalculator tpsCalculator, MongoClient mongoClient,
    ...
    public int processChange(ChangeStreamDocument<Document> event) {
        ...
        Document tAwards = tAwardsCollection.find(new Document("TrainId", tPlayerPoints.get("TrainId"))).first();
